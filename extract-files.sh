...
adb pull /system/etc/AdieHWCodec_NEL.csv ../../../vendor/htc/$DEVICE/proprietary
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/htc/__DEVICE__/proprietary/AdieHWCodec_NEL.csv:/system/etc/AdieHWCodec_NEL.csv \\
