...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 536606720
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1246445568
BOARD_FLASH_BLOCK_SIZE := 262144


TARGET_RELEASETOOLS_EXTENSIONS := device/htc/common
TARGET_PREBUILT_KERNEL := device/htc/lexikon/kernel

BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/htc/lexikon/recovery_ui.c
